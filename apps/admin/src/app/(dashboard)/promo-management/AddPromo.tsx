...
const categoryOptions: {
  ...
  { key: "up", icon: ArrowUp, label: "상단 위치" },
  { key: "down", icon: ArrowDown, label: "하단 위치" },
];
...
const AddPromo = () => {
  ...
  const [category, setCategory] = useState<CategoryType>("up");
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    addPromo(
      ...
      },
      {
        ...
        onError: (error: any) => {
          setError(
            error.response?.data?.message || "광고 등록에 실패했습니다."
          );
        },
      }
    );
    ...
    >
      ...
      <div>
        ...
        <input
          ...
          placeholder="예: 새로운 사은품 이벤트, 자금 만나보세요!"
