...
router.post('/events', adminAuth, upload.single('bannerImg'), createEvent);                    // 이벤트 등록
router.put('/events/:id', adminAuth, upload.single('bannerImg'), updateEvent);                 // 이벤트 수정
...
router.post('/advertisements', adminAuth, upload.single('imageUrl'), createAdvertisement);      // 광고 등록
router.put('/advertisements/:id', adminAuth, upload.single('imageUrl'), updateAdvertisement);   // 광고 수정
